 ...
 * 'developer_only' => true: hanya tampil untuk akun developer.
 */
return [
    ...
    'products' => ['label' => 'Produk',         'icon' => 'fa-solid fa-box',            'route' => 'admin.products.index',  'permission' => 'products.manage',  'group' => 'Katalog', 'active' => ['admin.products.index', 'admin.products.create', 'admin.products.edit']],
    'shopee_import' => ['label' => 'Import Shopee', 'icon' => 'fa-solid fa-cloud-arrow-up', 'route' => 'admin.products.import', 'permission' => 'products.manage',  'group' => 'Katalog', 'active' => ['admin.products.import*']],
    ...
    'flashsale' => ['label' => 'Diskon Produk',  'icon' => 'fa-solid fa-percent',        'route' => 'admin.flashsale.index', 'permission' => 'promos.manage',    'group' => 'Katalog'],
    ...
    'system' => ['label' => 'Sistem',         'icon' => 'fa-solid fa-screwdriver-wrench', 'route' => 'admin.system.index',  'permission' => 'settings.manage',  'group' => 'Pengaturan', 'developer_only' => true],
];
